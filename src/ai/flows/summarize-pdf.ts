 ...
 *
 * - summarizePdf - An exported function to initiate the PDF summarization flow.
 * - SummarizePdfInput - The input type for the summarizePdf function, a data URI of the PDF.
 * - SummarizePdfOutput - The output type for the summarizePdf function, the summary of the PDF.
 */
...
const summarizePdfPrompt = ai.definePrompt({
  ...
  Please summarize the PDF document provided. Focus on the key points and provide a concise summary.
